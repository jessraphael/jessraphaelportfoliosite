const userData = {
  ...
  address: 'Singapore',
  metaHeader: 'Software Engineer, Adventurer, Aspiring Technologist',
  ...
  projects: [
    ...
    },
    {
      ...
      imgUrl: '/influx.gif',
      description:
        'Aims to enable efficient discovery and connections between brands and influencers. \nFor brands, the key objective is to easily find and connect with relevant influencers that meet their campaign needs and target audience. The discovery features like search, sorting and filtering to help them identify ideal influencer partners. \nFor influencers, the goal is to get discovered by brands that align with their niche and interests. By joining brand waitlists and following brands, they make themselves discoverable for relevant brand partnerships and collaborations. \nOverall, this business objective facilitates discovery between brands and influencers to initiate successful influencer marketing partnerships.',
    },
    {
      title: 'SeeTurtle',
  ...
  experience: [
    ...
    {
      title: 'Industrial Attachment (Developer)',
      location: 'Singapore',
      company: 'Bank of America Merrill Lynch',
      year: 'Jan 2023 - Jun 2023',
      companyLink: 'https://www.bankofamerica.com/',
      desc: [
        'Drove multiple projects in Technology Risk including a major APAC data localization project (US$100mil) impacting entire bank landscape while ensuring compliance with data protection regulations through a comprehensive assessment and quality assurance of bank-wide internal applications. This involved identifying whether applications processed, transacted, gathered, or stored specific data, and implementing tailored remediation measures for different jurisdictions, mitigating risks.',
